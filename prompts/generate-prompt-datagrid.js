...
const promptTemplate = `## DataGrid 코드 생성을 위한 순차적 프롬프트 작성 체인
-
...
const coreFilePath = path.join(__dirname, `../src/components/DataGrid/${componentName}/Grid${componentName}.ts`);
const cssFilePath = path.join(__dirname, `../src/components/DataGrid/${componentName}/Grid${componentName}.css.ts`);
const wcFilePath = path.join(__dirname, `../src/components/DataGrid/${componentName}/Grid${componentName}.wc.ts`);
const storiesFilePath = path.join(__dirname, `../src/components/DataGrid/${componentName}/Grid${componentName}.stories.ts`);
const indexFilePath = path.join(__dirname, `../src/components/DataGrid/${componentName}/index.ts`);
